          ...
          <div class="col-lg-12">
            <form action="" class="form-horizontal" method="post" enctype="multipart/form-data">
              <div class="form-group">
                ...
                <div class="col-lg-9">
                  <input class="form-control" placeholder="Tên danh mục" type="text" name="name" />
              ...
              <div class="form-group">
                ...
                <div class="col-lg-9">
                  <input class="form-control" placeholder="Số lớn nhất sẽ hiển thị đầu tiên" type="text" name="sort_order"  onkeypress='return event.charCode >= 48 && event.charCode <= 57'/>
                </div>
              </div>
